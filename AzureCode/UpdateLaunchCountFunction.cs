...
public static class UpdateLaunchCountFunction
{
    [FunctionName("UpdateLaunchCountFunction")]
        ...
        ILogger log)
    {
        ...
        try
        {
            ...
            int newLaunchCount = data?.LaunchCount;

            if (string.IsNullOrEmpty(deviceId) || string.IsNullOrEmpty(email) || string.IsNullOrEmpty(password))
            {
                return new BadRequestObjectResult("Lütfen istek gövdesine DeviceId, EMail, Password ve NewLaunchCount ekleyin");
            }
            ...
            // LaunchCount değerini güncelle
            entity["LaunchCount"] = newLaunchCount;
